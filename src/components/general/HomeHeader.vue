        ...
        <div class="bg-container">
            <section >
                <span class="img-container">
                    <a href="https://twitter.com/maxaqq" target="_blank" class="circle">
                ...
                <div class="red-social">
                    ...
                    <a :href="redSocial.linkedin" target="_blank" class="social-media-twitter">
...
<style lang="scss" scoped>
    .header-container {
        ...
        .bg-container {
            width: 100%;
            height: 100%;
            background-color: rgba(11, 14, 28, 0.53);
